...
const Quotes = () => {
  ...
  return (
    <div className="min-h-screen py-12 sm:py-16 md:py-20 lg:py-24 relative overflow-hidden">
      ...
      {/* Subtle Accents - Responsive sizes */}
      <div className="absolute top-0 right-0 w-40 h-40 sm:w-60 sm:h-60 lg:w-80 lg:h-80 bg-gradient-to-bl from-amber-100/30 via-yellow-100/20 to-transparent rounded-full filter blur-3xl animate-pulse"></div>
      <div className="absolute bottom-0 left-0 w-48 h-48 sm:w-72 sm:h-72 lg:w-96 lg:h-96 bg-gradient-to-tr from-yellow-100/30 via-amber-100/20 to-transparent rounded-full filter blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
      ...
      <div className="absolute top-4 right-4 sm:top-8 sm:right-8 lg:top-10 lg:right-10 w-12 h-12 sm:w-16 sm:h-16 lg:w-20 lg:h-20 border-4 border-amber-200/30 rounded-tr-full animate-pulse"></div>
      <div className="absolute bottom-4 left-4 sm:bottom-8 sm:left-8 lg:bottom-10 lg:left-10 w-14 h-14 sm:w-20 sm:h-20 lg:w-24 lg:h-24 border-4 border-amber-200/30 rounded-bl-full animate-pulse" style={{ animationDelay: '1s' }}></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-base sm:text-lg lg:text-xl text-gray-700 max-w-2xl sm:max-w-3xl mx-auto leading-relaxed px-4">
        ...
        <motion.div
          ...
          className="bg-white border border-amber-200/50 rounded-2xl sm:rounded-3xl p-4 sm:p-6 lg:p-8 shadow-xl"
        ...
        >
          ...
          <div className="mt-6 sm:mt-8 flex flex-wrap justify-center gap-2 sm:gap-3 lg:gap-4">
            <button
              ...
              className="px-3 py-2 sm:px-4 sm:py-2.5 lg:px-6 lg:py-3 bg-gradient-to-r from-gray-700 to-gray-600 text-white rounded-lg sm:rounded-xl hover:from-gray-800 hover:to-gray-700 transition-all shadow-lg font-semibold text-xs sm:text-sm lg:text-base disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            <button
              ...
              disabled={loading || error || quotes.length === 0}
              className={`px-3 py-2 sm:px-4 sm:py-2.5 lg:px-6 lg:py-3 transition-all shadow-lg font-semibold text-xs sm:text-sm lg:text-base disabled:opacity-50 disabled:cursor-not-allowed ${
                isPaused
                  ? 'bg-gradient-to-r from-green-500 to-emerald-500 text-white hover:from-green-600 hover:to-emerald-600 hover:shadow-green-500/30 rounded-lg sm:rounded-xl'
                  : 'bg-gradient-to-r from-red-500 to-pink-500 text-white hover:from-red-600 hover:to-pink-600 hover:shadow-red-500/30 rounded-lg sm:rounded-xl'
              }`}
            >
              {isPaused ? <><span className="hidden sm:inline">▶ Play</span><span className="sm:hidden">▶</span></> : <><span className="hidden sm:inline">⏸ Pause</span><span className="sm:hidden">⏸</span></>}
            </button>
            <button
            ...
            <button
              ...
              disabled={loading || error || quotes.length === 0}
              className="px-3 py-2 sm:px-4 sm:py-2.5 lg:px-6 lg:py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-lg sm:rounded-xl hover:from-purple-700 hover:to-pink-700 transition-all shadow-lg font-semibold text-xs sm:text-sm lg:text-base disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            {error && (
              <button
                onClick={fetchQuotes}
                className="px-3 py-2 sm:px-4 sm:py-2.5 lg:px-6 lg:py-3 bg-gradient-to-r from-amber-500 to-orange-500 text-white rounded-lg sm:rounded-xl hover:from-amber-600 hover:to-orange-600 transition-all shadow-lg font-semibold text-xs sm:text-sm lg:text-base"
              >
